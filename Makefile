...
#    Updated: 2024/09/14 13:48:26 by mlarioui         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_strlen.c ft_strclpy.c ft_strlcat.c ft_strdup.c ft_strchr.c ft_strrchr.c \
		...
		ft_strnstr.c ft_strncmp.c ft_memchr.c ft_isprint.c
